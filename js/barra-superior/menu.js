  <header id="header">
    ...
    <script src="../js/barra-superior/menu.js"></script>
    <div id="logo-group">
    ...
    <div class="project-context hidden-xs">
      ...
      <ul class="dropdown-menu">
        ...
        <li>
          ...
          <button class="btn btn-default btn-sm text-right"><i class="fa fa-power-off"></i></button>
        </li>
        <li class="divider"></li>
        <li>
          <a href="javascript:void(0);"><i class="fa fa-power-off"></i> Fechar Todas</a>
        </li>
      </ul>
      <!-- end dropdown-menu-->
